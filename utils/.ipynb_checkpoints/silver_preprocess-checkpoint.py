...
def process_silver_tables(spark, input_path, output_path):
    clean_lms(spark, os.path.join(input_path, 'lms_loan_daily'), os.path.join(output_path, 'lms_loan_daily'))
    clean_attributes(spark, os.path.join(input_path, 'features_attributes'), os.path.join(output_path, 'features_attributes'))
    clean_financials(spark, os.path.join(input_path, 'features_financials'), os.path.join(output_path, 'features_financials'))
    pass_through_fc(spark, os.path.join(input_path, 'feature_clickstream'), os.path.join(output_path, 'feature_clickstream'))